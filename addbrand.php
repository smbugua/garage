...
?>
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="brands.php">Cities</a> <a href="#" class="current">Add City</a> </div>
    <h1>Add City</h1>
  </div>
